...
#!/usr/bin/env python3
"""
kkml2kunkunshi.py — Convertit un fichier KKML (Kunkunshi Markup Language)
en une tablature 工工四 au format SVG.

Usage:
    python3 kkml2kunkunshi.py chanson.kkml -o chanson.svg
    python3 kkml2kunkunshi.py chanson.kkml            # -> chanson.svg (même nom)
    cat chanson.kkml | python3 kkml2kunkunshi.py -     # depuis stdin -> stdout
